...
| Check | Status | Detail |
| --- | --- | --- |
| `package-manifest` | `pass` | Package manifest exists: C:\Users\simplelove\.codex\skills\us-overnight-a-stock-mapping\dist\1.0.0-openai\manifest.json |
...
| `archive-entry-us-overnight-a-stock-mapping/SKILL.md` | `pass` | Archive contains us-overnight-a-stock-mapping/SKILL.md |
| `archive-entry-us-overnight-a-stock-mapping/manifest.json` | `pass` | Archive contains us-overnight-a-stock-mapping/manifest.json |
| `archive-entry-us-overnight-a-stock-mapping/agents/interface.yaml` | `pass` | Archive contains us-overnight-a-stock-mapping/agents/interface.yaml |
